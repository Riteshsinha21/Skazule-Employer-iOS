...
protocol cancelAddPositionCustomDelegate {
    func alertFromCancelPopUp(Message: String)
}

class CustomAddPositionView: UIView {
    var view: UIView!
    var delegate: cancelAddPositionCustomDelegate?
    
    @IBOutlet weak var headerTitleLbl: UILabel!
    @IBOutlet weak var cancleButton: UIButton!
    @IBOutlet weak var addPositionTextField: UITextField!
    ...
    func loadViewFromNib() -> UIView {
        ...
        let nib = UINib(nibName: "CustomAddPositionView", bundle: bundle)
